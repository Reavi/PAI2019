<?php include("mainIndex.php") ?>
    ...
    <div class="content">
        <div class="statute">
            <h1 class="napis" style="font:3em Georgia;padding-bottom: 1em;">REGULAMIN</h1>
            <div class="napis">
        ...
        <div class="formPole" style="width: 70%;">
            <a href="?page=register"><button id="register" class="buttonDefault buttonDark">Powrót do rejestracji</button></a>
        </div>
    </div>
